  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <div
          ref={barRef}
          className={`group absolute top-0 flex h-[60px] items-center rounded-md transition-all hover:z-20 ${BAR_STYLES[item.pillar]} ${BAR_HOVER[item.pillar]} ${dragging ? "opacity-90 shadow-lg z-20" : ""} ${editing ? "cursor-text" : "cursor-grab active:cursor-grabbing"}`}
          style={{
            left: `${barLeft}px`,

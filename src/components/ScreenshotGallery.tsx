...
import { Camera, ExternalLink, Maximize2, X, Rows3, Grid2x2 } from 'lucide-react';
  ...
  return (
    <>
      <Card className="overflow-hidden">
        ...
        <div className="p-4">
          <div className={condensed ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" : "space-y-6"}>
            {pages.map(page => (
              <div
                key={page.id}

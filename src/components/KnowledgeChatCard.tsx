...
export function KnowledgeChatCard({ session, pages, selectedModel, reasoning, onModelChange, onReasoningChange, onDocumentsChanged }: Props) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] items-center">
      ...
      {/* Input area */}
      <div
        className={`mb-2 mt-0 rounded-2xl bg-card border-0 shadow-lg px-4 py-3 transition-colors w-full max-w-3xl mx-auto ${isDragging ? 'ring-2 ring-primary bg-primary/5' : ''}`}
        onDragEnter={(e) => {
          e.preventDefault();
          e.stopPropagation();

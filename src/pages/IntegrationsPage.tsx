...
const integrations: Integration[] = [
  ...
  { name: 'httpstatus.io', id: 'httpstatus', description: 'HTTP redirect chain analysis — follow every hop, see status codes, latency, TLS validity, and page metadata', secretKey: 'HTTPSTATUS_API_KEY', configured: true, category: 'security', status: 'active' },

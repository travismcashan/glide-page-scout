        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className={`w-full ${activeTab === 'chat' ? 'flex-1 flex flex-col min-h-0 overflow-hidden' : ''}`}>
          <div className="relative flex items-end justify-between">
            ...
            <TabsList className="relative h-auto bg-transparent p-0 rounded-none mb-0 gap-0 z-10">
              <TabsTrigger
                value="raw-data"
                style={activeTab === 'raw-data' ? { borderBottomColor: 'transparent', marginBottom: '-3px', paddingBottom: 'calc(0.625rem + 3px)', borderBottom: 'none', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 } : undefined}
              ...
              {(shouldShowIntegration('avoma', !!(session as any)?.avoma_data, showAllIntegrations) || shouldShowIntegration('hubspot', !!(session as any)?.hubspot_data, showAllIntegrations) || shouldShowIntegration('ocean', !!session?.ocean_data, showAllIntegrations) || shouldShowIntegration('apollo', !!session?.apollo_data, showAllIntegrations)) && (
                <TabsTrigger
                  value="prospecting"
                  style={activeTab === 'prospecting' ? { borderBottomColor: 'transparent', marginBottom: '-3px', paddingBottom: 'calc(0.625rem + 3px)', borderBottom: 'none', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 } : undefined}
                  className="relative text-base font-medium px-5 py-2.5 !rounded-none border-2 border-transparent bg-transparent text-muted-foreground transition-all !shadow-none !ring-0 data-[state=active]:border-foreground data-[state=active]:bg-background data-[state=active]:text-foreground"
                >
              ...
              <TabsTrigger
                value="ai-research"
                style={activeTab === 'ai-research' ? { borderBottomColor: 'transparent', marginBottom: '-3px', paddingBottom: 'calc(0.625rem + 3px)', borderBottom: 'none', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 } : undefined}
                className="relative text-base font-medium px-5 py-2.5 !rounded-none border-2 border-transparent bg-transparent text-muted-foreground transition-all !shadow-none !ring-0 data-[state=active]:border-foreground data-[state=active]:bg-background data-[state=active]:text-foreground"
              >
              ...
              <TabsTrigger
                value="knowledge"
                style={activeTab === 'knowledge' ? { borderBottomColor: 'transparent', marginBottom: '-3px', paddingBottom: 'calc(0.625rem + 3px)', borderBottom: 'none', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 } : undefined}
                className="relative text-base font-medium px-5 py-2.5 !rounded-none border-2 border-transparent bg-transparent text-muted-foreground transition-all !shadow-none !ring-0 data-[state=active]:border-foreground data-[state=active]:bg-background data-[state=active]:text-foreground"
              >
              ...
              <TabsTrigger
                value="chat"
                style={activeTab === 'chat' ? { borderBottomColor: 'transparent', marginBottom: '-3px', paddingBottom: 'calc(0.625rem + 3px)', borderBottom: 'none', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 } : undefined}
                className="relative text-base font-medium px-5 py-2.5 !rounded-none border-2 border-transparent bg-transparent text-muted-foreground transition-all !shadow-none !ring-0 data-[state=active]:border-foreground data-[state=active]:bg-background data-[state=active]:text-foreground"
              >

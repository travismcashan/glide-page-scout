        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="flex items-end justify-between border-b-2 border-foreground/30">
            <TabsList className="h-auto bg-transparent p-0 rounded-none mb-0 gap-0">
              <TabsTrigger
                value="raw-data"
                className="relative text-base font-medium px-5 py-2.5 rounded-none border-2 border-transparent bg-transparent data-[state=active]:border-foreground/30 data-[state=active]:border-b-0 data-[state=active]:bg-background data-[state=active]:-mb-[2px] data-[state=active]:pb-[calc(0.625rem+2px)] data-[state=active]:z-10 data-[state=active]:font-bold text-muted-foreground data-[state=active]:text-foreground data-[state=active]:shadow-none transition-all shadow-none"
              >

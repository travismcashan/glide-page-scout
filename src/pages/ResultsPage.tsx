        ...
        <div className="max-w-6xl mx-auto px-6 pt-8 pb-4">
           <div className="flex items-start justify-between">
             <div className="flex items-baseline gap-4">
               ...
               {session?.created_at && (
                 <div className="flex flex-col text-sm text-muted-foreground tabular-nums gap-0.5 -translate-y-3">
        ...
        {session && (
          <CollapsibleSection title="Design Analysis" collapsed={isSectionCollapsed("section-design-analysis") ?? false} onToggle={(c) => toggleSection("section-design-analysis", c)}>
            <SortedIntegrationList className="space-y-6">
              ...
              {session && shouldShowIntegration('screenshots', false, showAllIntegrations, isSharedView) && (
                <ScreenshotGallery
                  sessionId={session.id}
                  baseUrl={session.base_url}
                  discoveredUrls={discoveredUrls}
